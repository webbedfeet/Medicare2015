...
ggsave(here('docs','Result_Graphs/Figure-1-1.pdf'), plot = plt1)
```
...
conditions <- conditions %>% 
  ...
  mutate(condition = fct_relevel(condition, 'dementia','pvd','ulcers','healthy')) %>% 
...
ggplot(conditions, aes(x = prop, y = smr3)) + 
  ...
  geom_smooth(se = F, color = 'red') + 
  geom_hline(yintercept = 1, linetype = 2) +
  facet_wrap(~ condition, nrow=2, scales = 'free_x') +
