...
#### __Figure 2.__  Associations between the annual number of outpatient visits for knee complaints, the percent of beneficiaries living in rural areas, the percent of beneficiaries in Medicare managed care plans, and the number of surgeons performing total knee arthroplasties (TKA) per 100,000 beneficiaries and the observed/expected ratio for rates of primary total knee arthroplasty among white Medicare beneficiaries in each Health Referral Region.
...
#### __Figure 5.__  Association between the observed/expected ratios for rates of primary total knee arthroplasty between black Medicare beneficiaries and white Medicare beneficiaries.  Health Referral Regions that included at least 15,000 black beneficiaries are shown. 
...
#### _Figure 7.__ Association of observed-expected ratio OER) with knee arthroplasty volume by HRR. The lines represent the range of OER values over the 5 years of the study. 
...
library(scales)
ggplot(Dat, aes(x = N, y = SMR3, ymin = minoer, ymax = maxoer)) + 
  geom_pointrange(size = 0.5) + 
  scale_y_log10() + scale_x_continuous(labels = comma) +
  labs(x = 'Number of total knee arthroplasties', 
       y = 'Observed/Expected Ratio')
```

```{r post, include=F, message=F, results = 'hide'}
